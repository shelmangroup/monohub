...
func (HookStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5433d601b08611cc, []int{0}
}
...
func (m *HookResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HookResult.Merge(m, src)
}
...
func (*ReceiveOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_5433d601b08611cc, []int{1}
}
...
func (m *ReceiveOperation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReceiveOperation.Merge(m, src)
}
...
func (*PreReceiveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5433d601b08611cc, []int{2}
}
...
func (m *PreReceiveRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreReceiveRequest.Merge(m, src)
}
...
func init() { proto.RegisterFile("hooks.proto", fileDescriptor_5433d601b08611cc) }

var fileDescriptor_5433d601b08611cc = []byte{
